...
(function(){
  ...
  const css=`
    ...
    @media(max-width:700px){
      .hub-core-bottom{position:fixed;left:8px;right:8px;bottom:8px;z-index:1190;display:grid;grid-template-columns:repeat(5,1fr);gap:4px;padding:5px;border:1px solid #d6c6a7;border-radius:18px;background:#fffaf0ee;backdrop-filter:blur(10px);box-shadow:0 10px 30px #0003}
