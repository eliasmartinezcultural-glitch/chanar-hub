...
(function(){
  ...
  const css=`
    .hub-core-nav{display:flex;gap:7px;flex-wrap:wrap;align-items:center}\n    .hub-core-nav a{touch-action:manipulation}\n    .hub-core-bottom a{touch-action:manipulation}
    ...
    @media(max-width:700px){\n      .hub-core-nav{display:none!important}\n      .hub-core-bottom{position:fixed;left:8px;right:8px;bottom:calc(8px + env(safe-area-inset-bottom));z-index:1190;display:grid;grid-template-columns:repeat(5,1fr);gap:4px;padding:5px;border:1px solid #d6c6a7;border-radius:18px;background:#fffaf0ee;backdrop-filter:blur(10px);box-shadow:0 10px 30px #0003}
      ...
      .hub-core-quick{right:14px;bottom:calc(82px + env(safe-area-inset-bottom));font-size:13px;min-height:42px;padding:8px 12px}
